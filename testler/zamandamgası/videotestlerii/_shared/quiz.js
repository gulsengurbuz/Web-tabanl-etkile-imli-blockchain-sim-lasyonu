...
// /videotestleri/_shared/quiz.js
import { QUESTIONS, QUIZ_INDEX } from "./questions.js";
import { saveVideoQuizResult } from "../../shared/progress-client.js"; // yolunu proje yapına göre kontrol et
...
export function initQuiz({ slug, videoId }) {
  ...
  submitBtn.addEventListener("click", async () => {
    // Lock selections & mark correctness
    all.forEach((q,i)=>{
      locked[i]=true;
      const okIndex = q.choices.findIndex(c=>c.correct);
