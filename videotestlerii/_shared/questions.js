export const QUIZ_INDEX = [
  ...
  {
    id: 26,
    slug: "blockchain-turleri",
    title: "Blockchain Türleri — Mini Quiz",
  },
  {
    id: 27,
    slug: "blockchain-mekanizmasi",
    title: "Blockchain Mekanizması — Mini Quiz",
  },
];
...
export const QUESTIONS = {
  ...
  "blockchain-turleri": [
    {
      q: "Aşağıdakilerden hangisi public (açık) blockchain’in belirgin özelliğidir?",
      choices: [
        { text: "İzinli katılım", correct: false },
        { text: "Herkes okuyabilir ve doğrulayabilir", correct: true },
        { text: "Tek kurum yönetimi", correct: false },
      ],
    },
    {
      q: "Private ağlar tipik olarak hangi durumda tercih edilir?",
      choices: [
        {
          text: "Regülasyon ve gizlilik gereksinimleri olduğunda",
          correct: true,
        },
        { text: "Tam kamusal katılım istendiğinde", correct: false },
        { text: "Madencilik ödülleri dağıtılmak istendiğinde", correct: false },
      ],
    },
    {
      q: "Konsorsiyum blockchain’i en iyi hangisi açıklar?",
      choices: [
        { text: "Tek kurumun yönettiği kapalı ağ", correct: false },
        {
          text: "Birden fazla kurumun birlikte yönettiği izinli ağ",
          correct: true,
        },
        { text: "Herkese açık ve izinsiz ağ", correct: false },
      ],
    },
    {
      q: "Hibrit modellerin temel amacı nedir?",
      choices: [
        {
          text: "Public ve private özellikleri gereksinime göre dengelemek",
          correct: true,
        },
        { text: "Yalnızca gizlilik sağlamak", correct: false },
        { text: "Tüm yetkiyi tek kuruma vermek", correct: false },
      ],
    },
    {
      q: "Aşağıdakilerden hangisi public ağın tipik avantajıdır?",
      choices: [
        { text: "Sansüre dayanıklılık ve şeffaflık", correct: true },
        { text: "Varsayılan çok yüksek TPS", correct: false },
        { text: "Merkezi politika değişimi kolaylığı", correct: false },
      ],
    },
    {
      q: "Aşağıdaki eşleştirmelerden hangisi doğrudur?",
      choices: [
        { text: "Konsorsiyum ↔ herkes izinsiz katılım", correct: false },
        { text: "Private ↔ kurum içi süreçler / KVKK uyumu", correct: true },
        { text: "Public ↔ kapalı işlem görünürlüğü", correct: false },
      ],
    },
    {
      q: "Açıklık derecesine göre sıralama (en açıktan en kapalıya) aşağıdakilerden hangisine daha yakındır?",
      choices: [
        { text: "Public → Konsorsiyum → Private", correct: true },
        { text: "Private → Public → Konsorsiyum", correct: false },
        { text: "Konsorsiyum → Private → Public", correct: false },
      ],
    },
    {
      q: "Tedarik zinciri gibi birden çok kurumlu ve kısmen gizli verili senaryoda en uygun yaklaşım hangisine yakındır?",
      choices: [
        { text: "Tamamen public ağ", correct: false },
        {
          text: "Konsorsiyum + gerekli yerlerde şifreleme/zk ve gerekirse public kote",
          correct: true,
        },
        { text: "Sadece yan zincir (sidechain)", correct: false },
      ],
    },
  ],

  "blockchain-mekanizmasi": [
    {
      q: "Bir işlemin zincire giden tipik ilk adımı hangisidir?",
      choices: [
        {
          text: "İşlemin dijital imzalanması ve ağa yayınlanması",
          correct: true,
        },
        { text: "Özel anahtarın zincire yüklenmesi", correct: false },
        { text: "Doğrudan blok başlığına yazılması", correct: false },
      ],
    },
    {
      q: "Mempool nedir?",
      choices: [
        { text: "Onay bekleyen işlemler havuzu", correct: true },
        { text: "Blok başlığındaki zaman damgası", correct: false },
        { text: "Cüzdanların özel anahtar arşivi", correct: false },
      ],
    },
    {
      q: "Bir blok başlığında aşağıdakilerden hangisi bulunur?",
      choices: [
        { text: "Önceki blok hash’i", correct: true },
        { text: "Kullanıcı şifreleri", correct: false },
        { text: "Özel anahtarların ham hali", correct: false },
      ],
    },
    {
      q: "Merkle kökü neyi ifade eder?",
      choices: [
        {
          text: "Bloktaki işlemlerin ağaç yapısıyla tek özet değeri",
          correct: true,
        },
        { text: "Zincirin toplam zorluğu", correct: false },
        { text: "Cüzdan bakiyesi toplamı", correct: false },
      ],
    },
    {
      q: "PoW’da “üretmesi zor — doğrulaması kolay” ilkesini hangi ikili sağlar?",
      choices: [
        { text: "Nonce ve hedef zorluk", correct: true },
        { text: "Özel ve açık anahtar", correct: false },
        { text: "Gas limiti ve ücret", correct: false },
      ],
    },
    {
      q: "PoS’ta blok üreticisi seçimi tipik olarak neye dayanır?",
      choices: [
        { text: "Stake miktarı ve rastgelelik", correct: true },
        { text: "Nonce taraması", correct: false },
        { text: "Hash çakışması aramak", correct: false },
      ],
    },
    {
      q: "Zincir bütünlüğünü bozan en kritik değişiklik hangisidir?",
      choices: [
        { text: "Önceki hash alanının değiştirilmesi", correct: true },
        { text: "Blok boyutu değişkeni", correct: false },
        { text: "Cüzdan adres biçimi", correct: false },
      ],
    },
    {
      q: "Aşağıdakilerden hangisi işlem → blok → onay akışındaki doğru sıraya karşılık gelir?",
      choices: [
        {
          text: "İmzalama → Mempool → Bloğa dahil → Onayların artması",
          correct: true,
        },
        { text: "Bloğa dahil → İmzalama → Mempool → Onay", correct: false },
        { text: "Onay → İmzalama → Bloğa dahil → Mempool", correct: false },
      ],
    },
    {
      q: "PoW ağlarında fork sonrası geçerli zinciri seçmede yaygın kural hangisidir?",
      choices: [
        {
          text: "En çok toplam işe (total difficulty) sahip olan zincir",
          correct: true,
        },
        { text: "En eski genesis’e sahip zincir", correct: false },
        { text: "En fazla adres içeren zincir", correct: false },
      ],
    },
    {
      q: "Bir bloktaki onay sayısı arttıkça işlemin durumu için ne söylenebilir?",
      choices: [
        {
          text: "Geri alınma olasılığı azalır (finalite artar)",
          correct: true,
        },
        { text: "Her zaman aynı kalır", correct: false },
        { text: "Mutlaka geri alınır", correct: false },
      ],
    },
  ],
};
